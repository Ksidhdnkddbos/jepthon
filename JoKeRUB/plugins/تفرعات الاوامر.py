...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "2شـرح عـن اوامـر الـمنشن \n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n ᯽︙ اختر احدى هذه الاوامر \n\n- (`.منشن_كل_5دقايق + المسج`)\n\nقم بكتابة الامر في المجموعة لعمل تاك متقطع <كل 5 دقايق> بكلايش مختلفه للاعظاء الموجودين\nملاحضه عليك الانضمام الى قناة الكلايش\nرابطها : @Dev_karar\n\n- (`.الغاء_منشن_كل_5دقايق`)\nلألغاء التاك \n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n᯽︙ CH : @Lx5x5"
	)
@l313l.ar_cmd(
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شـرح عـن اوامـر الرسـائل الموقتـة\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n᯽︙ اختر احدى هذه الاوامر\n\n"
            "- ( `.ضبط_المؤقت + الوقت بالثواني` )\n"
            "لضبط الوقت الذي ستُحذف بعده جميع الرسائل التي ترسلها تلقائيًا. مثال: `.ضبط_المؤقت 10`\n\n"
            "- ( `.تعطيل_المؤقت` )\n"
            "لإيقاف حذف الرسائل التلقائي بعد الوقت المحدد.\n\n"
            "- ( `.مؤقت + الوقت + النص` )\n"
            "لإرسال رسالة واحدة يتم حذفها بعد وقت محدد. مثال: `.مؤقت 5 ههلا`\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n᯽︙ CH : @jepthon"
	)
@l313l.ar_cmd(
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شـرح عـن اوامـر الصـورة الذاتيـة\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n᯽︙ اختر احدى هذه الاوامر\n\n"
            "- ( `.ذاتية` )\n"
            "بالـرد عـلى الصـورة ذاتيـة الـتدمير ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر.\n\n"
            "- ( `.حفظ` )\n"
            "بالـرد عـلى الصـورة الموجودة في المجموعة ذات التقييد المحتوى ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر.\n\n"
            "- ( `.الذاتية تشغيل` )\n"
            "قم بكتابة الامر في أي مكان ليقوم بتفعيل الامر وحفظ الصور الذاتية التدمير تلقائياً.\n\n"
            "- ( `.الذاتية تعطيل` )\n"
            "قم بكتابة الامر في أي مكان لتقوم بتعطيل الامر وحفظ الصور الذاتية التدمير.\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n⌔︙Dev : @lx5x5"
	)
@l313l.ar_cmd(
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شـرح عـن اوامـر البصمـة الذاتيـة\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n᯽︙ اختر احدى هذه الاوامر\n\n"
            "- ( `.صوت` )\n"
            "بالـرد عـلى البصـمة ذاتيـة الـتدمير ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر.\n\n"
            "- ( `.جلب الصوت` )\n"
            "بالـرد عـلى البصمـة الموجودة في المجموعة ذات التقييد المحتوى ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر.\n\n"
            "- ( `.الصوت تشغيل` )\n"
            "قم بكتابة الامر في أي مكان ليقوم بتفعيل الامر وحفظ البصمات الذاتية التدمير تلقائياً.\n\n"
            "- ( `.الصوت تعطيل` )\n"
            "قم بكتابة الامر في أي مكان لتقوم بتعطيل امـر البصمات ذاتية التدمير.\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n⌔︙Dev : @lx5x5"
	)
@l313l.ar_cmd(
