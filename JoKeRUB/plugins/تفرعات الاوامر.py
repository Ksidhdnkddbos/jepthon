...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
        "شرح امر البصمة الذاتية :\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ( `.صوت` )\n بالـرد عـلى البصـمة ذاتيـة الـتدمير ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر \n- ( `.جلب الصوت` )\n بالـرد عـلى البصمـة الموجوده في المجموعة ذات التقييد المحتوى ليـقوم بـحفظها وارسالـها لك فـي الرسائل الـمحفوظة بسرية وبـدون عـلم الـطرف الأخر\n( `.الصوت تشغيل` )\n قم بكتابة الامر في أي مكان ليقوم بتفعيل الامر وحفظ البصمات الذاتية التدمير تلقائياً\n( `.الصوت تعطيل` )\n قم بكتابة الامر في مكان لتقوم بتعطيل امـر البصمات ذاتية التدمير\n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙Dev : @lx5x5"
	)
